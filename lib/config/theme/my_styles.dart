...
class MyPadding {
  static EdgeInsets getDynamicBottomPaddingWithFixedHorizontal(
      {double bottom = 0.0}) {
    return EdgeInsets.only(left: 24.w, right: 24.w, bottom: bottom.h);
  }

  static EdgeInsets getFixedHorizontalAndDynamicVerticalInsets(
      {double vertical = 0.0}) {
    return EdgeInsets.symmetric(horizontal: 24.w, vertical: vertical.h);
  }
}

class MyDecoration {
  static Decoration getGlassDecoration({double radius = 16}) {
