...
class PeriodView extends StatelessWidget {
  const PeriodView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return GetBuilder<PeriodController>(builder: (c) {
      return Container(
  ...
  Container animatedUI(PeriodController c, BuildContext context) {
    return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    sizedBox(height: 35),
                    Center(
                      child: headingText(Strings.periodLastsHeading.tr),
                    ),
                    c.days.isEmpty
                        ? Container(
                        ...
                        : Container(
                            ...
                            child: CupertinoPicker.builder(
                              ...
                              onSelectedItemChanged: (val) {
                                c.selected = DataList(itemName:(val+1).toString(), itemId: (val+1).toString());
                                c.data = DataList(
